...
product_name = 'Smarterp'
description = 'Smarterp Server'
long_desc = '''Smarterp is a complete ERP and CRM. The main features are accounting (analytic
...
author = 'SmartBygg AS'
author_email = 'info@smartbygg.no'
license = 'LGPL-3'

nt_service_name = "Smarterp-server-" + series.replace('~','-')
