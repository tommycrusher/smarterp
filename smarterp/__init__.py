...
# ----------------------------------------------------------
# smarterp must be a namespace package for smarterp.addons to become one too
...
MIN_PY_VERSION = (3, 10)
MAX_PY_VERSION = (3, 13)
assert sys.version_info > MIN_PY_VERSION, f"Outdated python version detected, Smarterp requires Python >= {'.'.join(map(str, MIN_PY_VERSION))} to run."
...
def registry(database_name=None):
    ...
    warnings.warn("Use directly smarterp.modules.registry.Registry", DeprecationWarning, 2)
